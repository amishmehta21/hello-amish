...
<%--<div class="post-container">
        <div class="post"><asp:Label ID="Label2" runat="server"></asp:Label></div>
        <div class="postedby">
...
<asp:ModalPopupExtender ID="mpe_Reply" TargetControlID="btnDummy" runat="server"
    ...
    <asp:HiddenField ID="hdnQuestId" runat="server" />   <%--am--%>
...
<div id="container">
    <div class="page-heading">View Reference
    </div>
    <div class="form-data">
        <div class="content">
    ...
    <tr>
        ...
        <td>
            <asp:Button ID="btnBack" runat="server" OnClick="btnBack_Click" Text="Back" CssClass="hidden" />
        </td>
    </tr>
</table>
        </div>
