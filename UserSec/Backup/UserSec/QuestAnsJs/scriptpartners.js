...
function dnpft(dnp)
{
	if(dnp=='f1')
	{
		document.getElementById('dnpft1').className='dnp-over';
		document.getElementById('dnpft2').className='dnp-out';
		document.getElementById('dnpft3').className='dnp-out';
	...
	if(dnp=='f2')
	{
		document.getElementById('dnpft2').className='dnp-over';
		document.getElementById('dnpft3').className='dnp-out';
		document.getElementById('dnpft1').className='dnp-out';
	...
	if(dnp=='f3')
	{
		document.getElementById('dnpft3').className='dnp-over';
		document.getElementById('dnpft1').className='dnp-out';
		document.getElementById('dnpft2').className='dnp-out';
...
fadeimages2[0]=["../QuestAnsImages/AboutUs/slider1.jpg"] //plain image syntax
fadeimages2[1]=["../QuestAnsImages/AboutUs/slider2.jpg"] //image with link syntax
fadeimages2[2]=["../QuestAnsImages/AboutUs/slider3.jpg"] //plain image syntax
//fadeimages2[9]=["/images/photo10.gif", "", ""] //image with link and target syntax
